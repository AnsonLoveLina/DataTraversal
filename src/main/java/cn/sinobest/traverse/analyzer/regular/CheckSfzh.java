...
/**
 * Created by zhouyi1 on 2016/1/26 0026.
 */
public class CheckSfzh {
     ...
     */
        public static boolean validate(String cardNumber) {
            ...
            Boolean cacheValidateResult = null;
            ...
            if (null == cacheValidateResult) {
                ...
                try {
                    Date birthDate = getBirthDate(cardNumber,cacheBirthDate);
                    ...
                    String realBirthdayPart = createBirthDateParser().format(
                            birthDate);
        ...
        private static Date getBirthDate(String cardNumber,Date cacheBirthDate) {
            if (null == cacheBirthDate) {
                try {
                    cacheBirthDate = createBirthDateParser().parse(
                            getBirthDayPart(cardNumber));
                } catch (Exception e) {
                    return null;
...
//         * @return
//         */
//        private int getGenderCode(String cardNumber) {
//            this.checkIfValid();
//            if(!result){
//                return 0;
//            }
...
//        }
        ...
        private static String contertToNewCardNumber(String oldCardNumber) {
            ...
            buf.append(CheckSfzh.calculateVerifyCode(buf));
            return buf.toString();
        }
